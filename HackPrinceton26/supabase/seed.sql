...
insert into chws (id, name, region, language, auth_token) values
  ...
  ('11111111-0000-0000-0000-000000000004', 'Demo CHW',        'zinder',    'english', 'demo')
...
insert into cases (id, chw_id, stage, risk_score, triage, clinical_note, referral_note, clinic_id, lat, lng, region, child_age_months, created_at) values
  (
